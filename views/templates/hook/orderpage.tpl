...
<div class="panel">
    ...
    <div class="panel panel-highlighted" id="Qliro-messages" style="padding: 0; margin: 0; display: none;">
...
<div class="panel">
    ...
    <div class="panel panel-highlighted" id="Qliro-transactions" style="padding: 0; margin: 0; display: none;">
        <div class="message-item">
